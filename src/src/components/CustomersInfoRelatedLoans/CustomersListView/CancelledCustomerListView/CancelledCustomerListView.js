...
import './CancelledCustomerListView.scss';
...
class CancelledCustomerListview extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loginToken:"",
      ...
      <Table className='table'>
        ...
        <TableBody>
          {this.state.allCustomer.map(row => (
            <TableRow className="Roww TextColour"  onClick={this.detailspage.bind(this)} style={{marginBottom:'30px'}}>
...
export default withRouter(CancelledCustomerListview);